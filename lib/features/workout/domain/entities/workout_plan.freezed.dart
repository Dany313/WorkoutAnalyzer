...
mixin _$WorkoutPlan {
  ...
  @override
  String toString() {
    return 'WorkoutPlan(id: $id, name: $name, sessions: $sessions)';
  }
}
...
abstract mixin class $WorkoutPlanCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String name, List<WorkoutSession> sessions});
}
...
extension WorkoutPlanPatterns on WorkoutPlan {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String id, String name, List<WorkoutSession> sessions)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _WorkoutPlan() when $default != null:
        return $default(_that.id, _that.name, _that.sessions);
      case _:
        return orElse();
    }
  }

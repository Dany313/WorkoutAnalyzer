...
mixin _$Exercise {
  ...
  @override
  String toString() {
    return 'Exercise(id: $id, name: $name, description: $description, sets: $sets)';
  }
}
...
abstract mixin class $ExerciseCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {String id, String name, String description, List<ExerciseSet> sets});
}
...
extension ExercisePatterns on Exercise {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _Exercise() when $default != null:
        return $default(_that.id, _that.name, _that.description, _that.sets);
      case _:
        return orElse();
    }
  }

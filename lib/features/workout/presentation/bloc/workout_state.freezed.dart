...
extension WorkoutStatePatterns on WorkoutState {
  ...
  TResult maybeWhen<TResult extends Object?>({
    ...
    TResult Function(List<WorkoutPlan> plans)? loaded,
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<WorkoutPlan> plans) loaded,
...
class _Loaded implements WorkoutState {
  const _Loaded({required List<WorkoutPlan> plans}) : _plans = plans;

  final List<WorkoutPlan> _plans;
  List<WorkoutPlan> get plans {
...
abstract mixin class _$LoadedCopyWith<$Res>
  ...
  @useResult
  $Res call({List<WorkoutPlan> plans});
}
